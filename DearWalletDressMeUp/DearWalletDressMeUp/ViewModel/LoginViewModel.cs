...
namespace DearWalletDressMeUp.ViewModel
{
    public class LoginViewModel : INotifyPropertyChanged
    {
        ...
        public async void Login(object parametar)
        {
           ...
           Tuple<bool, string> admin = Pomocna.JeLAdmin(korisnik.Username);
           Tuple<bool, string, Korisnik> meh = await Pomocna.ValidacijaLogina(korisnik.Username, korisnik.Sifra);
            ...
            {
                Pomocna.UlogovaniKorisnik = korisnik.Id.ToString();
