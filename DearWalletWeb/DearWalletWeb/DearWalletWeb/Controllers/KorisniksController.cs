...
namespace DearWalletWeb.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Ime,Prezime,Sifra,Email,Adresa,BrojTel,BrojKreditneKartice")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Ime,Prezime,Sifra,Email,Adresa,BrojTel,BrojKreditneKartice")] Korisnik korisnik)
        {
            if (ModelState.IsValid)
            {
