...
namespace DearWalletWeb.Controllers
{
    public class OdjevniPredmetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OdjevniPredmetId,NazivOdjevnogPredmeta,SlikaOdjevnogPredmeta,CijenaOdjevnogPredmeta,Odjel,Stil")] OdjevniPredmet odjevniPredmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OdjevniPredmetId,NazivOdjevnogPredmeta,SlikaOdjevnogPredmeta,CijenaOdjevnogPredmeta,Odjel,Stil")] OdjevniPredmet odjevniPredmet)
        {
            if (ModelState.IsValid)
            {
