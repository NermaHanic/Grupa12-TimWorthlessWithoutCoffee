...
namespace DearWalletWeb.Controllers
{
    public class DezensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NazivDezena,CijenaDezena")] Dezen dezen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NazivDezena,CijenaDezena")] Dezen dezen)
        {
            if (ModelState.IsValid)
            {
